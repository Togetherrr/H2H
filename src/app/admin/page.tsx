            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-2">
              <Card className="border-slate-200 shadow-sm">
                ...
                <CardContent className="grid gap-4">
                  <Link href="?tab=users" className="group flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4 transition-colors hover:bg-slate-100 hover:border-slate-200">
                    <div>
                  ...
                  <Link href="?tab=members" className="group flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4 transition-colors hover:bg-slate-100 hover:border-slate-200">
                    <div>
                  ...
                  <Link href="?tab=socials" className="group flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 p-4 transition-colors hover:bg-slate-100 hover:border-slate-200">
                    <div>
